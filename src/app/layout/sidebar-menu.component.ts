...
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
    ...
    getMenuItems(): MenuItem[] {
        return [
            ...
            new MenuItem(this.l('UserApplications'), '/app/UserApplications', 'fas fa-list'),
            new MenuItem(this.l('BackOfficeApplications'), '/app/BackOfficeApplications', 'fas fa-list'),
            new MenuItem(
                this.l('Roles'),
                '/app/roles',
